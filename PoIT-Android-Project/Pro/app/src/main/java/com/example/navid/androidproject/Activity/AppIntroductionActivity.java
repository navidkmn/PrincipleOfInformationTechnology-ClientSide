...
import com.example.navid.androidproject.Other.FirstLaunchDetection;
...
public class AppIntroductionActivity extends AppCompatActivity{
    ...
    private FirstLaunchDetection firstLaunchDetection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstLaunchDetection = new FirstLaunchDetection(this);
//        if (!firstLaunchDetection.isFirstTimeLaunch()) {
//            launchHomeScreen();
//            finish();
//        }
    ...
    private void launchHomeScreen() {
        //firstLaunchDetection.setFirstTimeLaunch(false);
