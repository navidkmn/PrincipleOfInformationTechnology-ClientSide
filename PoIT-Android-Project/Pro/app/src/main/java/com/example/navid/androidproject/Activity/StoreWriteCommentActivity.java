...
public class StoreWriteCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_write_comment);
                ...
                if(_comment.getText().toString().isEmpty()){
                    ...
                    if(Float.toString(_rate.getRating()).equals("0.0")){
                        ...
                        if(Float.toString(_rate2.getRating()).equals("0.0")) {
                            ...
                            progressDialog = new ProgressDialog(StoreWriteCommentActivity.this, R.style.AppTheme_Dark_Dialog);
            ...
            public void onResponse(String response) {
                if(!response.equals("")) {
                    if(response.equals("1")){
                        ...
                        Intent intent = new Intent();
                        intent.putExtra("comment", _comment.getText().toString());
                        intent.putExtra("priceRate", Float.toString(_rate.getRating()));
                        intent.putExtra("qualityRate",Float.toString(_rate2.getRating()));
